...
class VPSDE(SDE):
  def __init__(self, beta_min=0.1, beta_max=20, N=1000, smallest_time=1e-5):
    ...
    """
    super().__init__(N, smallest_time)
...
class VESDE(SDE):
  def __init__(self, sigma_min=0.01, sigma_max=50, N=1000, linear=False, smallest_time=1e-5):
